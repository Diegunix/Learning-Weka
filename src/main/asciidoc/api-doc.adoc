...
[introduction]
= Introduction
API-service is a RESTful microservice for management Momit devices.
...
include::{snippets}/weather-controller-rest-docs-test/get-localidades/request-parameters.adoc[]
